...
const onDrop = (event: any) => {
  console.log('Dropped in preview:', event, previewForm.value);
};

const onDragEnd = (event: any) => {
  console.log('Drag ended:', event, previewForm.value);
};
</script>
      ...
      <div class="flex flex-col w-full h-[calc(100vh-12rem)] border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 p-4">
        ...
        >
          <template #item="{ element }">
            <div class="mb-4 w-full flex gap-2 flex-row border-gray-200 border-0 hover:border-2 p-4 rounded-lg">
              ...
              <div class="flex flex-row px-4 items-center gap-2 w-2/10 justify-center">
                ...
                <button class="drag-handle" :aria-label="`Drag to reorder ${element.label}`">
