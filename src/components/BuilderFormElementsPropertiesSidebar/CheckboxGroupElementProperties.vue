<!-- components/BuilderFormElementsPropertiesSidebar/CheckboxGroupElementProperties.vue -->
...
// Reuse the same editable list pattern as SelectElementProperties
...
<template>
  ...
  <!-- Checkbox Options (reusing the same pattern as select) -->
  <SidebarGroup>
    <div class="flex flex-row gap-2 items-center">
      <SidebarGroupLabel>Checkbox options</SidebarGroupLabel>
      <button 
        ...
        <SidebarMenuItem>
          <div class="space-y-2">
            <div 
              ...
              :key="`checkbox-row-${element.id}-${index}`"
